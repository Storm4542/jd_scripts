/*
京小超兑换奖品 脚本地址：https://raw.githubusercontent.com/Storm4542/jd_scripts/master/jd_blueCoin.js
感谢@yangtingxiao提供PR
更新时间：2020-11-05
支持京东多个账号
...
[task_local]
#京小超兑换奖品
0 0 0 * * * https://raw.githubusercontent.com/Storm4542/jd_scripts/master/jd_blueCoin.js, tag=京小超兑换奖品, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jxc.png, enabled=true
====================Loon=================
[Script]
cron "0 0 0 * * *" script-path=https://raw.githubusercontent.com/Storm4542/jd_scripts/master/jd_blueCoin.js,tag=京小超兑换奖品
===================Surge==================
京小超兑换奖品 = type=cron,cronexp="0 0 0 * * *",wake-system=1,timeout=20,script-path=https://raw.githubusercontent.com/Storm4542/jd_scripts/master/jd_blueCoin.js
 */
const $ = new Env('京小超兑换奖品');
const notify = $.isNode() ? require('./sendNotify') : '';
//Node.js用户请在jdCookie.js处填写京东ck;
const jdCookieNode = $.isNode() ? require('./jdCookie.js') : '';
let coinToBeans = $.getdata('coinToBeans') || '碧浪 洗衣凝珠'; //兑换多少数量的京豆（20或者1000），0默认兑换不兑换，如需兑换把0改成20或者1000，或者'商品名称'(商品名称放到单引号内)即可
